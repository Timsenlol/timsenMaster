...
\newcommand{\titel}{Entwicklung einer resilienten und skalierbaren Cloud-native Schnittstellenarchitektur für eine Jahresabschluss-Softwarelösung}
\newcommand{\artderarbeit}{Masterarbeit}  % {Bachelorarbeit,Masterarbeit}
\newcommand{\autor}{Tim Wirzius}
\newcommand{\studiengang}{Software Engineering}  % {Informatik,Wirtschaftsinformatik,Medieninformatik}
\newcommand{\matrikelnr}{3804283}
\newcommand{\erstgutachter}{Dirk Beinert}
\newcommand{\zweitgutachter}{Prof.\,Dr.~Thomas Schedel}
...
\include{content/3_state}
\include{content/4_architecture}
\include{content/5_prototype}
\include{content/6_discussion}
\include{content/7_conclusion}
